...
import {
  CheckboxTree,
  type CheckboxTreeOption as OptionCheckbox,
...
interface RightPanelProps {
  ...
  categoryOptions: OptionCheckbox[]
  categoryValues: OptionCheckbox[]
  onCategoryValuesChange: (value: OptionCheckbox[]) => void
  tagOptions: Option[]
  tagValues: Option[]
  onTagValuesChange: (value: Option[]) => void
}
                    ...
                    {featured ? (
                      <div className="group relative aspect-video overflow-hidden rounded-md border">
                        ...
                        <button
                          ...
                          className="absolute inset-0 flex cursor-pointer items-center justify-center bg-black/40 text-xs font-medium text-white opacity-0 transition-opacity group-hover:opacity-100"
                        >
                          Change
                        </button>
                      </div>
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="aspect-video h-32 w-full"
                        onClick={onPickFeatured}
                      >
                    ...
                    <AccordionItem value="categories">
                      ...
                      <AccordionContent>
                        <CheckboxTree
                          ...
                          onChange={onCategoryValuesChange}
                        />
                      </AccordionContent>
                    </AccordionItem>
